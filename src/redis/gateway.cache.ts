...
export class GatewayCache {
    ...
    /*
    Redis: LPOS() function look up for position of an object by key
           LPUSH() function left push to array (in cache)
           LRANGE() function returns string[] in the selected range from: 0 (first element)
           to -1 (all array) dependes on key string
    */
    ...
    /* Redis: LREM() function removes user or record from cache */
