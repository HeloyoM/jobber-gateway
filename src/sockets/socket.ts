...
import { IMessageDocument, winstonLogger } from "@heloyom/shared-develope-tools";
...
export class SocketIOAppHandler {
    ...
    public listen(): void {
        ...
        this.io.on('connection', async (socket: Socket) => {
            ...
            /* selectedCategories event name is appropriate to the event name from gig-service/controllers/get.ts */
